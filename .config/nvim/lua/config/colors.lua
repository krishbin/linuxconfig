...
local highlights = {
    ...
    CursorLine = { fg = c.transparent, bg = c.grey4 },
    CursorColumn = { fg = c.transparent, bg = c.grey4 },
    ColorColumn = { fg = c.transparent, bg = c.grey4 },
    LineNr = { fg = c.hidden },
